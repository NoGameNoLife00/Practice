...
import com.bugcoding.framework.proxy.Proxy;
import com.bugcoding.framework.proxy.ProxyManager;
import com.bugcoding.framework.proxy.TransactionProxy;
...
public final class AopHelper {
    ...
    static {
        try {
            ...
            Map<Class<?>, List<Proxy>> targetMap = createTargetClassSet(proxyMap);
    ...
    private static Map<Class<?>, List<Proxy>> createTargetClassSet(Map<Class<?>, Set<Class<?>>> proxyMap) throws Exception {
